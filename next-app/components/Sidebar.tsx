...
export default function Sidebar({
  ...
  return (
    <aside className="sticky top-0 h-screen overflow-y-auto bg-[#6B3300] flex flex-col px-5 py-6">
      <div className="flex flex-col items-center gap-3">
        ...
        <div className="text-center">
          <p className="font-extrabold text-2xl leading-tight tracking-wide text-white">
