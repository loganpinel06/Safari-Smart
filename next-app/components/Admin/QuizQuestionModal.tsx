//modal for creating and editing quiz questions, used in the admin quiz page.
...
export type EditableQuizQuestion = {
  ...
  question: string;
  choices?: Array<{ name: string; correct: boolean }> | null;
  path?: string | null;
};

enum QuizQuestionModalModeType {
  Create = "create",
  Edit = "edit",
}
...
export default function QuizQuestionModal({
  ...
  useEffect(() => {
    ...
    if (mode === "edit" && question) {
      setQuestionType((question.type as QuizQuestionModalType) || "Text");
      ...
      <div className="flex max-h-[92vh] w-full max-w-6xl flex-col overflow-hidden rounded-2xl bg-[#FFF1E5] shadow-lg">
        <div className="border-b border-[#4B3A46]/15 px-6 py-4">
          <h2 className="text-xl font-bold text-[#592803] md:text-2xl">
            {isEdit ? "Edit quiz question" : "Create quiz question"}
          </h2>
